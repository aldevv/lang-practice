...
int main() {
  ...
  // Create socket
  // (AF is adress family, INET is ipv4)
  // SOCK_STREAM, socket will accept streams
  // 0 means choose the protocol automatically (TCP is a stream protocol)
  // so probably will choose that
  ...
  while (1) {
    ...
    // this blocks the application if accept is empty
